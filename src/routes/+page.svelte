...
<main>
	...
	<div class="notes">
		...
		<p>
			The data on the <a href="https://open.toronto.ca/dataset/outdoor-artificial-ice-rinks/">locations of outdoor skating rinks</a> were acquired from the City of Toronto's Open Data website. We manually added to this dataset outdoor rinks not operated directly by the City (Brick Works, Bentway). Not that there are a few outdoor skating rinks in neighbouring regions (e.g. Pickering, Mississauga, etc.) that might provide better access for Toronto residents living adjacent to these municipalities, but we wanted to focus our analysis to just within the City of Toronto jurisdiction. 
		</p>
		<p>
