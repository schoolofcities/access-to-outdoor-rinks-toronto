...
<main>
	...
	<div class="text">
		...
		<p>
			Note that there are also a number of indoor skating rinks in Toronto, but we don't include them on this map, since indoor rinks have far fewer public skating hours and typically do not have public ice hockey times. Indoor rinks usually require a small fee for entrance. Skating indoors is also a different experience than outdoors. Part of the a attraction of outdoor skating rinks is being outside during the winter.
		</p>
