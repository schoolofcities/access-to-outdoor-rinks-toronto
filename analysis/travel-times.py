...
tt = pd.read_csv("data/tt_matrix.csv")
...
min_tt_wt_630.to_csv("data/access-min-travel-time.csv")
...
travel_time_matrix_walk.to_csv("data/tt_matrix_walk.csv", index = True)
#fill na values to 120 min max
tt_walk = pd.read_csv("data/tt_matrix_walk.csv")
...
min_tt_walk.to_csv("data/min_walking_travel_time")
...
travel_time_matrix_computer_transit_weekday.to_csv("data/tt_matrix_transit_weekday", index = True)
#fill na values to 120 min max
tt_transit_weekday = pd.read_csv("data/tt_matrix_transit_weekday")
...
min_tt_transit_weekday.to_csv("data/min_transit_travel_time")
...
travel_time_matrix_computer_transit_weekend.to_csv("data/tt_matrix_transit_weekend", index = True)
#fill na values to 120 min max
tt_matrix_transit_weekend = pd.read_csv("data/tt_matrix_transit_weekend")
...
min_tt_transit_weekend.to_csv("data/min_tt_transit_weekend")
...
final.to_csv("data/travel_time_final.csv")
